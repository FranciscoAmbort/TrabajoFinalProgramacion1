...
document.getElementById('FormularioAgregarCompra').addEventListener('submit', function (event) {
    ...
    const datos = {
        ...
        FechaDeEntrega: document.getElementById('FechaDeEntrega').value,
    };

    // Enviar los datos a una API REST (sustituye la URL por la de tu API)
    fetch(`https://localhost:7026/Compra`, {
        method: 'POST',
        headers: {
